...
public class MyBatisExample {
    ...
    public static void main(String args[]) throws SQLException {
       ...
       //System.out.println(pmap.loadPacienteById(2,"cc"));
        MyBatisExample exam = new MyBatisExample();
        //Aca se agrega un paciente coon 0 consultas.
    //  Paciente tmp = new Paciente(104, "CC", "Victor Elias", new java.sql.Date(0));
      Consulta c = new Consulta(new java.sql.Date(0),"Nada");
      //La consulta c es agregada  con su foranea como el id del Paciente tmp
      exam.registrarConsultaaPaciente(pmap, c, 104, "CC");

      
      //Aca se agrega el paciente 
        //exam.registrarNuevoPaciente(pmap,tmp);
        
        
       //Cargamos el paciente para verificar sus consultas
        System.out.println("Paciente cargado :" + pmap.loadPacienteById(104,"CC"));
       sqlss.commit();
